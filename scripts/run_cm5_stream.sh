...
echo "Starting CM5 headless stream profile=$DEVICE_PROFILE backend=$SMARTGLASSES_CAMERA_BACKEND scene=$SCENE_CAMERA connector=$SCENE_CAMERA_CONNECTOR eye=$EYE_CAMERA out=$SMARTGLASSES_OUTDIR"
